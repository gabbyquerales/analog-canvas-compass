...
- Tests: 85 → 116 (per-flag F1 on/off Rec & Parks, F3 timing-notice scenarios incl. coexistence with real blockers, F2/F4 copy and schema assertions, form-gating checks, hidden-field pruning incl. the stale-toggle repro and gate-chain cascade).
